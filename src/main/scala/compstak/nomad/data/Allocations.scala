...
object Allocations {
  ...
  final case class Alloc(
    ...
    desiredDescription: Option[String],
    clientStatus: String,
    clientDescription: String,
    taskStates: Option[Map[String, TaskState]],
    createIndex: Int,
    modifyIndex: Int,
    createTime: Long,
    modifyTime: Long
    ...
    implicit val decoderForAllocation = new Decoder[Alloc] {
      def apply(c: HCursor): Decoder.Result[Alloc] =
        (
          ...
          c.downField("DesiredDescription").as[Option[String]],
          c.downField("ClientStatus").as[String],
          c.downField("ClientDescription").as[String],
          c.downField("TaskStates").as[Option[Map[String, TaskState]]],
